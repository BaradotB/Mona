	...
	return (
		<div className="footer">
			...
			<div className="footer_column">
				...
				<p>
					<img
						src="https://i2.wp.com/cdn.onlinewebfonts.com/svg/img_401526.png"
						alt="phone"
					/>
					<a href="tel:+79788472402">+7 (978) 847-24-02</a>
				</p>
				<a
				...
				>
					<img
						src="https://mtort.ru/templates/modern/img/icon-yandex-maps-marker.svg"
						alt="phone"
					/>
					Адрес: просп. Александра Суворова, 19, Симферополь{' '}
				</a>
			</div>
			<a href="https://t.me/MONA_EAT" className="footer_iconHref">
				<svg
